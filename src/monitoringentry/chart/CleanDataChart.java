 ...
 * @author Habib
 */
public class CleanDataChart extends JPanel{
    public CleanDataChart() {
    ...
    private PieDataset createDataset() {
        ...
        dataset.setValue("Data Clean", B1Dao.getInstance().getCleanCount());
        dataset.setValue("Belum Clean", B1Dao.getInstance().getRowCount()-data);
        return dataset;
    }
