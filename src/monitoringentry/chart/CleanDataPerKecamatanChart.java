 ...
 * @author Toshiba
 */
public class CleanDataPerKecamatanChart extends JPanel{
    ...
    */
    public CleanDataPerKecamatanChart(String kec) {
        this.kec = kec;
    ...
    private JFreeChart createChart(PieDataset dataset) {
        ...
        JFreeChart chart = ChartFactory.createPieChart("Summary Data Masuk di Kecamatan", dataset, true, true, false);
        chart.removeLegend();
