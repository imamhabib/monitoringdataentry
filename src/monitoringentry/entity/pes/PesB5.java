...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PesB5.findAll", query = "SELECT p FROM PesB5 p")})
public class PesB5 implements Serializable {
    ...
    public PesB5(String nks) {
        this.nks = nks;
    }

    public PesB5(String nks, String b5ar1, String b5ar2s1, Date b5ar2s2, int b5br1s1, int b5br1s2) {
        this.nks = nks;
        this.b5ar1 = b5ar1;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PesB5)) {
            return false;
        }
        PesB5 other = (PesB5) object;
    ...
    public String toString() {
        return "pkl54.entity.pes.PesB5[ nks=" + nks + " ]";
    }
