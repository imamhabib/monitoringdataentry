...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PesB4.findAll", query = "SELECT p FROM PesB4 p")})
public class PesB4 implements Serializable {
    ...
    public PesB4(String nks) {
        this.nks = nks;
    }

    public PesB4(String nks, String b4r1, String b4r2, int b4r3, int b4r4, int b4r5, int b4r6, int b4r7, String b4r8, String b4r9, String b4r10, int b4r11, String b4r12) {
        this.nks = nks;
        this.b4r1 = b4r1;
        this.b4r2 = b4r2;
        this.b4r3 = b4r3;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PesB4)) {
            return false;
        }
        PesB4 other = (PesB4) object;
    ...
    public String toString() {
        return "pkl54.entity.pes.PesB4[ nks=" + nks + " ]";
    }
