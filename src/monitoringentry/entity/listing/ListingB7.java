 ...
 */
@Entity
@Table(name = "listing_b7")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ListingB7.findAll", query = "SELECT l FROM ListingB7 l")})
public class ListingB7 implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ListingB7)) {
            return false;
        }
        ListingB7 other = (ListingB7) object;
    ...
    public String toString() {
        return "pkl54.entity.listing.ListingB7[ nks=" + nks + " ]";
    }
