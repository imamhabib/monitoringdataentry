 ...
 */
@Entity
@Table(name = "listing_b3")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ListingB3.findAll", query = "SELECT l FROM ListingB3 l")})
public class ListingB3 implements Serializable {
    ...
    public ListingB3(String nks) {
        this.nks = nks;
    }

    public ListingB3(String nks, String b3r1s1, String b3r1s2, String b3r2s1, String b3r2s2, Date b3r3s1, Date b3r3s2) {
        this.nks = nks;
        this.b3r1s1 = b3r1s1;
        this.b3r1s2 = b3r1s2;
        this.b3r2s1 = b3r2s1;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ListingB3)) {
            return false;
        }
        ListingB3 other = (ListingB3) object;
    ...
    public String toString() {
        return "pkl54.entity.listing.ListingB3[ nks=" + nks + " ]";
    }
